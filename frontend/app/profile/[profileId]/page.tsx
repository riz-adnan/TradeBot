                ...
                <div id="container" className="p-20 w-auto flex px-24 justify-center relative">
                    <div id="container" className="p-20 sm:p-16 md:p-20 lg:p-24 xl:p-20 w-auto flex flex-col md:flex-row px-4 sm:px-8 md:px-24 lg:px-24 xl:px-24 relative">
                        <div className="mr-10 mt-10">
                            <Image
                                className="rounded-lg min-w-[100px] w-[50rem] h-auto"
                        ...
                        {!edit ? <div className="w-full sm:w-[70%] md:w-[60%] lg:w-[50%]">
                            ...
                            <div className="text-white w-full sm:w-[35rem] md:w-[30rem] lg:w-[25rem] mb-10">
                                <div className='text-white'><span className='font-bold text-xl text-yellow-400'>Public Key:</span> <span className='pl-[1.35rem]'>{profile.publicKey}</span></div>
                                <div className="flex items-center space-x-2">
                                    <span className="font-bold text-xl text-yellow-400">Private Key:</span>
                                    <p className='pl-2'>{isPrivateVisible ? profile.privateKey : '*********'}</p>
                                    <button
                                        onClick={() => setIsPrivateVisible(!isPrivateVisible)}
                                        className="px-2 py-1 bg-blue-500 text-white rounded"
                                    >
                                        {isPrivateVisible ? 'Hide' : 'Show'}
                                    </button>
                                </div>
                                <div className='text-white'><span className='font-bold text-xl text-yellow-400'>Base Url:</span> <span className='pl-[2.65rem]'>{profile.baseUrl}</span></div>
                            </div>
                            ...
                            <form onSubmit={handleEditProfile} className="w-full sm:w-[70%] md:w-[60%] lg:w-[50%]">
                                <input
                                    className="text-white font-bold text-xl mt-6 bg-black rounded-3xl py-2 px-4 w-72"
                                    value={profile.name}
                                ...
                                <div className="text-white w-[30rem] mb-10 flex flex-col gap-y-2 sm:w-[35rem] md:w-[30rem] lg:w-[30rem]">
                                    <div className='text-white'>
                                        <span className='font-bold text-xl text-yellow-400'>Public Key:</span>
                                        <input
                                            className='ml-[1.35rem] bg-black rounded-3xl py-2 px-4 w-72'
                                    ...
                                    <div className="flex items-center">
                                        <span className="font-bold text-xl text-yellow-400">Private Key:</span>
                                        <input
                                            className='ml-[0.8rem] bg-black rounded-3xl py-2 px-4 w-72'
                                            value={profile.privateKey}
                                            onChange={(e) => setProfile({ ...profile, privateKey: e.target.value })}
                                        />
                                    </div>
                                    <div className='text-white'>
                                        <span className='font-bold text-xl text-yellow-400'>Base Url:</span>
                                        <input
                                            className='ml-[2.65rem] bg-black rounded-3xl py-2 px-4 w-72'

        ...
        <main className="min-h-screen flex items-stretch text-white ">
            <div className="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style={{ backgroundImage: "url(https://images.unsplash.com/photo-1577495508048-b635879837f1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=675&q=80)" }}>
                ...
                <div className="bottom-0 absolute p-4 text-center right-0 left-0 flex justify-center space-x-4">
                    Don't worry! we trade with paper money only.
                </div>
            </div>
            <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0 bg-[#161616]">
                ...
                <div className="w-full py-6 z-20">
                    ...
                    <form onSubmit={handleSignup} className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                        ...
                        <div className="py-1">
                            <input type="text" name="privateapi" id="privateapi" placeholder="Public API Key" value={publicApi} onChange={(e: any) => setPublicApi(e.target.value)} className="block w-full p-3 text-md rounded-lg bg-black" />
                        </div>
                        <div className="py-1">
                        ...
                        <div className="py-1">
                            <input type="text" name="baseUrl" id="baseUrl" placeholder="Base URL" value={baseUrl} onChange={(e: any) => setBaseUrl(e.target.value)} className="block w-full p-3 text-md rounded-lg bg-black" />
                        </div>
                        ...
                        <div className="py-1">
                            <input className="block w-full p-3 text-md rounded-lg bg-black" type="password" name="password" id="password" placeholder="Confirm Password" value={confirmPassword} onChange={(e: any) => setConfirmPassword(e.target.value)} />
                        </div>
